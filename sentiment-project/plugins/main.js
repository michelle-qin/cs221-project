...
function onLoad(assignmentId, ownerName, lastChanged, piazzaReleasePostUrl) {
  ...
  header.append($('<div>')
    ...
    .append($('<div>').append('Stanford CS221 Spring 2020-2021'.bold())));
  ...
  header.append($('<p>').append("<b> WARNING: </b> Non-typeset submissions will not be accepted. <b> If your submission is not typeset, we will request that you typeset it and re-submit, possibly using late days.</b>"));
