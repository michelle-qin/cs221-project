    ...
    with open(csv_file_path, 'w') as fout:
        ...
        with open(json_file_path) as fin:
            ...
            for line in fin:
                ...
                if (get_row(line_contents, column_names) != []): 
...
def get_row(line_contents, column_names):
    ...
    for column_name in column_names:
        ...
        if (column_name == "text"):
            ...
            #covid_regex = 'mask' | "covid" | "sanitize" | "coronavirus" | "social distanc" | "social-distanc" | "pandemic" | "superspreader" | "hygiene" | "outdoor din"
            covid_regex = ["mask", "covid", "sanitize", "sanitize", "coronavirus", "social distanc", "social-distanc", "pandemic", "superspreader", "hygiene", "outdoor din"]
            to_return = []
            to_return = [ele for ele in covid_regex if(ele in line_value)]
            if to_return == []: 
