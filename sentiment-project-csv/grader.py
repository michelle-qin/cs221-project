...
grader.add_basic_part('3b-2-basic', test3b2, max_points=2, max_seconds=1000000, description="test classifier on real polarity dev dataset")
...
grader.add_manual_part('4c', max_points=4, description='handling same-cluster constraints')
grader.add_manual_part('4d', max_points=2, description='rerunning kmeans')
